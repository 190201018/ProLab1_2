...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        futbolcular.add(new Futbolcu("Quaresma", "Besiktas",new ImageIcon("quaresma.PNG"), 80, 95, 65));
        futbolcular.add(new Futbolcu("Neymar", "Paris",new ImageIcon("neymar.PNG"), 95, 85, 90));
        futbolcular.add(new Futbolcu("Atiba", "Besitas",new ImageIcon("atiba.PNG"), 75, 85, 80));
        futbolcular.add(new Futbolcu("Henderson", "Liverpool",new ImageIcon("henderson.PNG"), 95, 75, 85));
        futbolcular.add(new Futbolcu("Ramos", "Real Madrid", new ImageIcon("ramos.PNG"),100, 90, 80));
        futbolcular.add(new Futbolcu("Ozyakup", "Besiktas", new ImageIcon("ozyakup.PNG"),70, 70, 60));
        futbolcular.add(new Futbolcu("Dorukhan", "Besitas",new ImageIcon("dorukhan.PNG"), 85, 75, 70));
